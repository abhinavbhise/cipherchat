...
def handle_message(data):
    ...
    for client_sid, client_username in active_users.items():
        client_key = encryption_keys.get(client_username, "default")
        encrypted_text = xor_cipher(message_text, client_key)
        
        socketio.emit('server_message', 
                      {'type': 'chat', 'sender': sender, 'content': encrypted_text}, 
                      room=client_sid)
